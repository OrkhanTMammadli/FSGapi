...
public interface JournalEntryMapper {
    ...
    JournalEntry toJournalEntry(ResponseJournal responseJournal);

    @Mapping(target = "account", ignore = true)
    @Mapping(target = "transactionId", ignore = true)
    void updateJournalEntryFromRequest(ResponseJournal responseJournal, @MappingTarget JournalEntry journalEntry);
